...
const avatarDropdown = (
  <Menu className="app-header-dropdown">
    ...
    <Menu.Divider />
    <Menu.Item key="3"> <a href={DEMO.headerLink.signOut} onClick={logout}><Icon type="logout" />Sign out</a> </Menu.Item>
  </Menu>
);
            ...
            <div className="list-unstyled list-inline">
              ...
              <Dropdown className="list-inline-item" overlay={avatarDropdown} trigger={['click']} placement="bottomRight">
                <a className="ant-dropdown-link no-link-style" href={DEMO.link}>
                  ...
                  <span className="avatar-text d-none d-md-inline">Pixelz Warrios</span>
                </a>
              </Dropdown>
            </div>
          </div>
