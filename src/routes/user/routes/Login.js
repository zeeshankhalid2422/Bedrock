...
import LoginForm2 from 'routes/form/routes/forms/components/LoginForm1';
...
const FormCard = () => (
  <section className="form-card-page form-card row no-gutters">
    ...
    <div className="form-card__body offset-lg-3 col-lg-6 p-5 px-lg-8 d-flex align-items-center">
      <LoginForm2 />
    </div>
  </section>
)
